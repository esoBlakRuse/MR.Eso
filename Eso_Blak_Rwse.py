...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"           Assalamu'@eso_hawlery. ^_^")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Eso Blak Rwse            |"
    print GL+"  |            Telegram:  @pashae_it            |"
    print WW+"  |            Snapchat: yhawlery809            |"
    print Y+"  |            INSTAGRAM: eso_work0              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••  HACK FACEBOOK Ruse ^_^   •••••••••|"
    print GG+"  √=============================================√"
        ...
        -o:  -.eso...        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              ...
              Powered by:\033[97m Eso Blak Rwse
      """
